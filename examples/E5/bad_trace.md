...
|--------|--------|------|---------|-----|------|
| `public` | `prices` | `AccessExclusiveLock` | Table | 24630 | ❌ |
| `public` | `prices` | `ShareLock` | Table | 24630 | ❌ |
| `public` | `prices_pkey` | `AccessExclusiveLock` | Index | 24634 | ❌ |
